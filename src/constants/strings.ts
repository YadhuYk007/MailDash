...
consent:`\n\nBy clicking on 'Accept & Continue', you agree to enable 2-Step Verification (if not already enabled) and generate an App Password to securely access your account through this app. This process enhances your account security and ensures that your data remains protected.\n`
}